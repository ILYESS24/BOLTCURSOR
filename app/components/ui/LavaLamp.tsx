...
const LavaLampContent = () => {
  return (
    <div style={{ width: '100%', height: '100%', background: '#000', position: "fixed", top: 0, left: 0, zIndex: -1 }}>
      <Canvas
        camera={{
          left: -0.5,
          right: 0.5,
...
export const LavaLamp = () => {
  return (
    <ClientOnly fallback={<div style={{ width: '100%', height: '100%', background: '#000', position: "fixed", top: 0, left: 0, zIndex: -1 }} />}>
      {() => <LavaLampContent />}
    </ClientOnly>
  );
}
